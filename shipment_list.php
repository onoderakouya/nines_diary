...
$fields = $pdo->query("SELECT id,label FROM fields ORDER BY CAST(SUBSTRING_INDEX(label, '-', 1) AS UNSIGNED), CAST(SUBSTRING_INDEX(label, '-', -1) AS UNSIGNED), label")->fetchAll();
  ...
  <?php foreach ($rows as $r): ?>
    ...
    <div class="card">
      ...
      <div class="section-sm" style="display:flex;justify-content:flex-end;gap:8px;align-items:center;flex-wrap:wrap">
        <a class="btn" href="shipment_edit.php?id=<?= (int)$r['id'] ?>">編集</a>
