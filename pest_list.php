...
<title>病害虫 一覧</title>
<h1>病害虫 一覧</h1>
<p><a href="index.php">←ホーム</a> / <a href="pest_new.php">＋追加</a></p>
...
<?php foreach ($rows as $r): ?>
  <div style="padding:10px 0;border-bottom:1px solid #ddd">
    ...
    <div><b>症状:</b><br><?=nl2br(e($r['symptom_text']))?></div>
    <?php if (!empty($r['action_text'])): ?>
      <div><b>対応:</b><br><?=nl2br(e($r['action_text']))?></div>
    <?php endif; ?>
    <?php if (!empty($r['photo_path'])): ?>
      <div><img src="<?=e($r['photo_path'])?>" style="max-width:320px;border:1px solid #ccc"></div>
    <?php endif; ?>
  </div>
<?php endforeach; ?>
